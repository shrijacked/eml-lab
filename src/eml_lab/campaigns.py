...
CAMPAIGNS: dict[str, CampaignSpec] = {
    ...
    "phase2-research-sweep": CampaignSpec(
        name="phase2-research-sweep",
        description="Seed sweep for research-tier hard targets with explicit failure reporting.",
        steps=(
            CampaignStep(
                name="research-square-seed0",
                kind="train",
                target="square",
                required=False,
                seed=0,
